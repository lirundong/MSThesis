...
%---------------------------------------------------------------------------%
\documentclass[twoside, fontset=sourcefounder, openany]{Style/ucasthesis}%
...
%->> Document settings
%---------------------------------------------------------------------------%
\usepackage[authoryear, list, table, color, tikz]{Style/artratex}% document settings
...
%-
\input{Tex/Frontinfo}
% \input{Tex/Frontinfo_anonymous} % for double-blind review
\begin{document}
%-
...
% \input{Tex/Backmatter_anonymous}% other information
\end{document}
%---------------------------------------------------------------------------%
